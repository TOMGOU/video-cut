...
class VideoClip(QWidget):
  ...
  def initUI(self):
    ...
    self.save_le = QLineEdit('/Users/tangyong/test/automation/video-cut/PIP', self)
    ...
    self.timer_le = QLineEdit(r'/Users/tangyong/test/automation/video-cut/tiktok/timer.mp4', self)
    ...
    self.mask_le = QLineEdit(r'/Users/tangyong/test/automation/video-cut/tiktok/mask.mp4', self)
