...
class VideoClip(QWidget):
  ...
  def initUI(self):
    ...
    self.source_le = QLineEdit(r'/Users/tangyong/test/automation/video-cut/nba/HC.mp4', self)
    ...
    self.save_le = QLineEdit(r'/Users/tangyong/test/automation/video-cut/nba/finished/HC.mp4', self)
    ...
    self.text2_le = QLineEdit('Clutch Mode. GG.', self)
